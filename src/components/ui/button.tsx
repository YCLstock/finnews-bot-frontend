...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-sm hover:bg-primary/90 hover:shadow-md border border-primary/20 rounded-xl backdrop-blur-sm",
        destructive:
          "bg-destructive text-white shadow-sm hover:bg-destructive/90 hover:shadow-md focus-visible:ring-destructive/20 rounded-xl border border-destructive/20 backdrop-blur-sm",
        outline:
        ...
        ghost:
          "hover:bg-accent/50 hover:text-accent-foreground rounded-xl backdrop-blur-sm",
        link: "text-primary underline-offset-4 hover:underline rounded-lg",
      },
      size: {
        default: "h-12 md:h-10 px-5 py-2.5 has-[>svg]:px-4 text-base md:text-sm",
        sm: "h-10 md:h-8 px-3 py-2 gap-1.5 has-[>svg]:px-2.5 text-sm md:text-xs",
